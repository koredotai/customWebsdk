function stopBgm() {
	...
	const audioTag = document.getElementById('islandGameBgm');
	...
	customTemplate.prototype.renderMessage = function (msgData) {
		...
		if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "dropdown_template") {
			...
			messageHtml = $(this.getChatTemplate("ratingTemplate")).tmpl({
			 ...
			 this.bindEvents(messageHtml);
			 $(messageHtml).data(msgData);
		}else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "sesseionEndTemplate") {
			messageHtml = $(this.getChatTemplate("sesseionEndTemplate")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
		}else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "islandGameQuickReplyTemplate") {
			messageHtml = $(this.getChatTemplate("islandGameQuickReplyTemplate")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
		}else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "dateCalenderTemplate") {
			messageHtml = $(this.getChatTemplate("dateCalenderTemplate")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
		...
		else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "videoQuickreply") {
			messageHtml = $(this.getChatTemplate("videoQuickreply")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
			setTimeout(function () {
				document.getElementById("addYoutube").innerHTML = ''; //loop controls
				document.getElementById("addYoutube").innerHTML = '<video autoplay width=100% height=100%><source src="videos/'+ msgData.message[0].component.payload.youtubuId +'.mp4#t='+ msgData.message[0].component.payload.start +',' + msgData.message[0].component.payload.end +'" type="video/mp4"><strong>브라우저에서 비디오 재생을 지원하지 않습니다.</strong></video>';
				var evt = document.createEvent("HTMLEvents");
				evt.initEvent('resize', true, false);
				window.dispatchEvent(evt);
			}, 150);
		}
		else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "youtubeQuickreply") {
			messageHtml = $(this.getChatTemplate("youtubeQuickreply")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
			setTimeout(function () {
				...
				document.getElementById("addYoutube").innerHTML = '<iframe width=75% height=100% src="https://www.youtube.com/embed/'+ msgData.message[0].component.payload.youtubuId +'?start='+ msgData.message[0].component.payload.start +'&end=' + msgData.message[0].component.payload.end +'&autoplay=1" title="'+ msgData.message[0].component.payload.text +'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
				var evt = document.createEvent("HTMLEvents");
				evt.initEvent('resize', true, false);
				window.dispatchEvent(evt);
			}, 150);
		}
		else if (msgData.message[0] && msgData.message[0].component && msgData.message[0].component.payload && msgData.message[0].component.payload.template_type == "youtubeQuickreply2") {
			messageHtml = $(this.getChatTemplate("youtubeQuickreply2")).tmpl({
				'msgData': msgData,
				'helpers': this.helpers,
				'extension': this.extension
			});
			setTimeout(function () {
				var showFullTableModal = document.getElementsByClassName("showMore");
					for (var i = 0; i < showFullTableModal.length; i++) {
						...
						document.getElementsByClassName("largePreviewContent")[0].innerHTML = '<iframe width=75% height=100% src="https://www.youtube.com/embed/'+ msgData.message[0].component.payload.youtubuId +'?start='+ msgData.message[0].component.payload.start +'&end=' + msgData.message[0].component.payload.end +'&autoplay=1" title="'+ msgData.message[0].component.payload.text +'" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
						...
						showFullTableModal[i].onclick = function () {
							...
							$(".largePreviewContent").empty();
							//$(".largePreviewContent").html($(parentli).find('.tablechartDiv').html());
							document.getElementsByClassName("largePreviewContent")[0].innerHTML = '<iframe width="1200" height="700" src="https://www.youtube.com/embed/NyyAdZKEzTY?start='+ msgData.message[0].component.payload.start +'&end=' + msgData.message[0].component.payload.end +'&autoplay=1" title="한미 아모디핀 스크립트" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>';
							//$(parentli).find('.tablechartDiv').clone().appendTo(".largePreviewContent");
							modal.style.display = "block";
							// Get the <span> element that closes the modal
							var span = document.getElementsByClassName("closeElePreview")[0];
...
print(JSON.stringify(message)); */
	...
	var sesseionEndTemplate = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
		{{if msgData.message}} \
						...
						<div class="fa fa-chevron-left quickreplyLeftIcon hide"></div><div class="fa fa-chevron-right quickreplyRightIcon"></div>\
							<div class="quick_replies_btn_parent"><div class="autoWidth">\
								{{each(key, msgItem) msgData.message[0].component.payload.quick_replies}} \
									<div class="buttonTmplContentChild quickReplyDiv"> <span {{if msgItem.payload}}value="${msgItem.payload}"{{/if}} class="quickReply {{if msgItem.image_url}}with-img{{/if}}" onClick="window.location.reload()" type="${msgItem.content_type}">\
		...
		var islandGameQuickReplyTemplate = 
			'<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
				{{if msgData.message[0].component.payload.bgmName}}\
					<img src onerror="stopBgm()">\
					{{if msgData.message[0].component.payload.bgmLoop}}\
						<audio id="islandGameBgm" autoplay loop><source src="../bgm/${msgData.message[0].component.payload.bgmName}"></audio>\
						{{else}}<audio id="islandGameBgm" autoplay><source src="../bgm/${msgData.message[0].component.payload.bgmName}"></audio>\
					{{/if}} \
				{{/if}} \
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        ...
                        <div class="buttonTmplContent"> \
                            ...
                            {{if msgData.icon}}<div aria-live="off" class="profile-photo"> <div class="user-account avtar marginT50" style="background-image:url(${msgData.icon})"></div> </div> {{/if}} \
                            {{if msgData.message[0].component.payload.text}} \
                                <div class="buttonTmplContentHeading quickReply fadeInMsg"> \
                                    {{if msgData.type === "bot_response"}} {{html helpers.convertMDtoHTML(msgData.message[0].component.payload.text, "bot")}} {{else}} {{html helpers.convertMDtoHTML(msgData.message[0].component.payload.text, "user")}} {{/if}} \
                                    {{if msgData.message[0].cInfo && msgData.message[0].cInfo.emoji}} \
                                        <span class="emojione emojione-${msgData.message[0].cInfo.emoji[0].code}">${msgData.message[0].cInfo.emoji[0].title}</span> \
                                    {{/if}} \
                                ...
                                <div class="fa fa-chevron-left quickreplyLeftIcon hide"></div><div class="fa fa-chevron-right quickreplyRightIcon hide"></div>\
                                    <div class="quick_replies_btn_parent fadeInMsg"><div class="autoWidth">\
                                        {{each(key, msgItem) msgData.message[0].component.payload.quick_replies}} \
		...
		var dateCalenderTemplate = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        ...
                        <div class="buttonTmplContent"> \
                            ...
                            <ul class="buttonTmplContentBox">\
                                ...
                                {{each(key, msgItem) msgData.message[0].component.payload.buttons}} \
                                    <a href=""#>\
                                        <li {{if msgData}}msgData="${JSON.stringify(msgData)}"{{/if}} {{if msgItem.payload}}value="${msgItem.payload}"{{/if}} {{if msgItem.payload}}actual-value="${msgItem.payload}"{{/if}} {{if msgItem.url}}url="${msgItem.url}"{{/if}} class="buttonTmplContentChild sdkCalender calenderBtn" data-value="${msgItem.value}">\
                                            ${msgItem.title}\
                                        </li> \
                                    </a> \
                                {{/each}} \
            ...
            var videoQuickreply = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon quickReplies"> \
                        <div class="buttonTmplContent"> \
                            ...
                            {{if msgData.message[0].component.payload.text}} \
                                ...
                                <div class="fa fa-chevron-left quickreplyLeftIcon hide"></div><div class="fa fa-chevron-right quickreplyRightIcon hide"></div>\
                                    <div class="quick_replies_btn_parent"><div class="autoWidth">\
                                        {{each(key, msgItem) msgData.message[0].component.payload.quick_replies}} \
                                            <div class="buttonTmplContentChild quickReplyDiv"> <span {{if msgItem.payload}}value="${msgItem.payload}"{{/if}} class="quickReply {{if msgItem.image_url}}with-img{{/if}}" type="${msgItem.content_type}">\
                                                {{if msgItem.image_url}}<img src="${msgItem.image_url}">{{/if}} <span class="quickreplyText {{if msgItem.image_url}}with-img{{/if}}" {{if msgItem.url}}onclick="location.href=`${msgItem.url}`"{{/if}}>${msgItem.title}</span></span>\
                                            </div> \
                                        {{/each}} \
                                    </div>\
                                </div>\
		    ...
		    var youtubeQuickreply = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon quickReplies"> \
                        <div class="buttonTmplContent"> \
		...
		var youtubeQuickreply2 = '<script id="chat_message_tmpl" type="text/x-jqury-tmpl"> \
                {{if msgData.message}} \
                    <li data-time="${msgData.createdOnTimemillis}" id="${msgData.messageId || msgItem.clientMessageId}"\
                        class="{{if msgData.type === "bot_response"}}fromOtherUsers{{else}}fromCurrentUser{{/if}} with-icon"> \
                        <div class="buttonTmplContent"> \
                            ...
                            <ul class="buttonTmplContentBox">\
								...
								<a href=""#>\
									<li class="buttonTmplContentChild showMore">\
										영상보기\
									</li> \
								</a> \
                                {{each(key, msgItem) msgData.message[0].component.payload.buttons}} \
		...
		if (tempType === "dropdown_template") {
			...
			return listWidget;
		}else if (tempType === "sesseionEndTemplate") {
			return sesseionEndTemplate;
		}else if (tempType === "islandGameQuickReplyTemplate") {
			return islandGameQuickReplyTemplate;
		}else if (tempType === "dateCalenderTemplate") {
			return dateCalenderTemplate;
		}else if (tempType === "videoQuickreply") {
			return videoQuickreply;
		}else if (tempType === "youtubeQuickreply") {
			return youtubeQuickreply;
		}else if (tempType === "youtubeQuickreply2") {
			return youtubeQuickreply2;
		}else {
			return "";
		}
		return "";
